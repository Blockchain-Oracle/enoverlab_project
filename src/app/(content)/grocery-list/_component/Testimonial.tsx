    ...
    <div className="bg-green py-16">
      <div className="container relative mx-auto px-4">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          onClick={previous}
          className="absolute left-4 top-1/2 -translate-y-1/2 rounded-full bg-white/90 p-2 transition-colors duration-200 hover:bg-white"
        >
          <ChevronLeft className="text-green-600 h-6 w-6" />
        </motion.button>
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          onClick={next}
          className="absolute right-4 top-1/2 -translate-y-1/2 rounded-full bg-white/90 p-2 transition-colors duration-200 hover:bg-white"
        >
              ...
              >
                <span
                  className={`block h-2 w-2 rounded-full transition-all duration-200 ease-out ${
                    currentSlide === index
                      ? "scale-100 bg-white"
                      : "scale-90 bg-white/50 group-hover:scale-100"
                  }`}
                />
              </button>
            ))}
